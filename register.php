...
<div class="page_body">
    ...
    <form name="edit_register" method="post" action="save_register.php">
        ...
        <div class="weui_cells weui_cells_form">
            <div class="weui_cell">
                <div class="weui_cell_bd weui_cell_primary">
                                    <textarea class="weui_textarea" placeholder="写给给主办方的悄悄话" name="message" rows="4"
        ...
        $query = sprintf("select * from event_info natural join event_registration_date natural join event_registration_common where
            confirm=true and ((register_date_type='date_st' and '%s' < date) or (register_date_type='date_ed' and '%s' < register_date));",
            $now_time, $now_time);
        //echo $query;
