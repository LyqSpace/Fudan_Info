...
<div class="page_body">
    <?php
        ...
        $query = sprintf("select * from event_info as i left join event_registration as r on i.event_id=r.event_id where
            register=true and
    ...
    <?php
        ...
        while ($event_info = mysql_fetch_assoc($event_list)) {
            ...
            $query = sprintf("select * from users natural join event_info natural join event_registration as r left join event_date as d on r.event_id=d.event_id where r.event_id=%s;",
                $event_info['event_id']);
            //echo $query;
            ...
            <form name="edit_register" method="post" onsubmit="return check_register();" action="save_register.php">
                ...
                <div class="weui_cells weui_cells_form">
                    ...
                    if ($registration_info['registration_id'] == true) {
                        ...
                        <div class="weui_cell">
                            ...
                            <div class="weui_cell_bd weui_cell_primary">
                                <input class="weui_input" type="number" pattern="[0-9]*" name="registration_id"
                    ...
                    if ($registration_info['registration_major'] == true) {
                        ...
                        <div class="weui_cell">
                            ...
                            <div class="weui_cell_bd weui_cell_primary">
                                <input class="weui_input" type="text" required="required" name="registration_major"
                                       placeholder="请输入专业">
                            </div>
                        </div>
                        <?php
                ...
                while ($registration_info = mysql_fetch_assoc($registration_list)) {
                    ...
                    ?>>
                        ...
                        <div class="weui_cells_title">留言板</div>
                        <div class="weui_cells weui_cells_form">
                            <div class="weui_cell">
                                <div class="weui_cell_bd weui_cell_primary">
