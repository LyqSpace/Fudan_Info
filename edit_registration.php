...
-->
                        ...
                        <div class="weui_cells weui_cells_checkbox">
                            <label class="weui_cell weui_check_label" for="registration_id">
                                <div class="weui_cell_hd">
                                    <input type="checkbox" class="weui_check" name="registration_id" id="registration_id" <?php if ($row['registration_id'] == 1) echo 'checked="checked"'; ?>/>
                            ...
                            <label class="weui_cell weui_check_label" for="registration_name">
                                <div class="weui_cell_hd">
                                    <input type="checkbox" class="weui_check" name="registration_name" id="registration_name" <?php if ($row['registration_name'] == 1) echo 'checked="checked"'; ?>/>
                                    <i class="weui_icon_checked"></i>
                                </div>
                                <div class="weui_cell_bd weui_cell_primary">
                                    <p>姓名</p>
                            ...
                            <label class="weui_cell weui_check_label" for="registration_major">
                                <div class="weui_cell_hd">
                                    <input type="checkbox" class="weui_check" name="registration_major" id="registration_major" <?php if ($row['registration_major'] == 1) echo 'checked="checked"'; ?>/>
                                    <i class="weui_icon_checked"></i>
                                </div>
                                <div class="weui_cell_bd weui_cell_primary">
                                    <p>专业</p>
                            ...
                            <label class="weui_cell weui_check_label" for="registration_phone">
                                <div class="weui_cell_hd">
                                    <input type="checkbox" class="weui_check" name="registration_phone" id="registration_phone" <?php if ($row['registration_phone'] == 1) echo 'checked="checked"'; ?>/>
                                    <i class="weui_icon_checked"></i>
                                </div>
                                <div class="weui_cell_bd weui_cell_primary">
                                    <p>手机号码</p>
                    ...
                    <div class="weui_cells weui_cells_form">
                        <div class="weui_cell">
                            ...
                            <div class="weui_cell_bd weui_cell_primary">
                                <input class="weui_input" type="number" required="required" name="ticket_per_person" pattern="[0-9]*" placeholder="请输入每位用户最多能取几张票" value="<?php
                            ...
                            while (true) {
                                ...
                                <div class="weui_cells weui_cells_form" id="<?php echo "date_" . $cnt;?>">
                                    <div class="weui_cell">
                                        ...
                                        <div class="weui_cell_bd weui_cell_primary">
                                            <input class="weui_input" name="<?php echo "date_" . $cnt;?>" type="datetime-local" required="required" value="<?php
                                    ...
                                    <div class="weui_cell">
                                        ...
                                        <div class="weui_cell_bd weui_cell_primary">
                                            <input class="weui_input" type="number" required="required" name="<?php echo "ticket_count_" . $cnt;?>" pattern="[0-9]*" placeholder="请输入可以通过此方式取票/报名的总票数" value="<?php
