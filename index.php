                    ...
                    <div class="page_body">
                        ...
                        <div class="weui_cells weui_cells_form">
                            ...
                            <div class="weui_cell">
                                ...
                                <div class="weui_cell_bd weui_cell_primary">
                                    <input class="weui_input" type="number" pattern="[0-9]*" required="required" name="registration_phone_tmp"
                            ...
                            <div class="weui_cell">
                                <div class="weui_cell_bd weui_cell_primary">
                                    <textarea class="weui_textarea" placeholder="写给给主办方的话" name="registration_message_tmp" rows="2"
                                                id="registration_message"
                                                onkeyup="count('registration_message', registration_message_cnt, 200);"><?php echo $_COOKIE['guest_event_message'];?></textarea>
                                    <div class="weui_textarea_counter"><span id="registration_message_cnt"><?php echo count_str($_COOKIE['guest_event_message']); ?></span>/200
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="weui_cell weui_cell_select weui_select_after">
                            ...
                            <div class="weui_cell_bd weui_cell_primary">
                                <select class="weui_select" name="event_id" id="select_event"
                                ...
                                ?>>
                                    <form name="edit_register" method="post" onsubmit="return check_register();"
                                        ...
                                        <div class="weui_cell weui_cell_select weui_select_after">
                                            ...
                                            <div class="weui_cell_bd weui_cell_primary">
                                                <select class="weui_select" name="registration_serial"
                                        ...
                                        while ($registration_info = mysql_fetch_assoc($registration_list)) {
                                            ...
                                            ?>>
                                                <div class="weui_cells_title">
                                                    剩余票数<span
                                                        id="info_green"><?php echo $registration_info['ticket_count'] - $registration_info['register_count']; ?></span>张，每人最多可取<span
